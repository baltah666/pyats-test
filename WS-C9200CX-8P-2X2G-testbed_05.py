...
# ==================================================
# GET DEVICES FROM LIBRENMS (HTTPS, verify=False)
# ==================================================
...
for family, items in inventories_by_family.items():
    ...
    with open(filename, "w", encoding="utf-8") as f:
        f.write(template.render(inventory=items))

    print(f"✅ Generated {filename}")

print("\n🎉 All pyATS testbeds generated successfully (HTTPS)")
